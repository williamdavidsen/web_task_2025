...
{
    /// <inheritdoc />
    public partial class DomainUsersRename : Migration
    {
        /// <inheritdoc />
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.CheckConstraint("CK_AvailableSlot_TimeRange", "[EndTime] > [StartTime]");
                    table.ForeignKey(
                        name: "FK_AvailableSlots_DomainUsers_PersonnelId",
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    table.PrimaryKey("PK_TaskList", x => new { x.AppointmentId, x.CareTaskId });
                    table.ForeignKey(
                        name: "FK_TaskList_Appointments_AppointmentId",
                        column: x => x.AppointmentId,
                        principalTable: "Appointments",
                        principalColumn: "AppointmentId",
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_TaskList_CareTasks_CareTaskId",
                        column: x => x.CareTaskId,
                        principalTable: "CareTasks",
                        principalColumn: "CareTaskId",
                        onDelete: ReferentialAction.Restrict);
                });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_AvailableSlots_PersonnelId_Day_StartTime_EndTime",
                table: "AvailableSlots",
                columns: new[] { "PersonnelId", "Day", "StartTime", "EndTime" },
                unique: true);
